...
<section class="mt-10">
  <div class="container mx-auto max-w-3xl bg-base-100 p-8 rounded-2xl shadow-md">
    <h1 class="text-2xl font-bold mb-6 text-center">📂 게시판 관리</h1>

    <!-- 게시판 등록 -->
    <form action="doAddBoard" method="get" class="mb-10 border rounded-xl p-6">
      <h2 class="text-lg font-semibold mb-4">🆕 게시판 추가</h2>
      <div class="form-control mb-4">
        <label class="label font-semibold">게시판 이름</label>
        ...
        <tbody>
          <c:forEach var="board" items="${boards}">
            <tr>
              ...
              <td>
                <form action="doDeleteBoard" method="get" onsubmit="return confirm('정말 삭제하시겠습니까?');">
                  <input type="hidden" name="boardId" value="${board.getId() }" />
